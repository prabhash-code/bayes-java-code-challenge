...
public class MatchController {
    ...
    public ResponseEntity<Long> ingestCombatLog(@RequestBody @NotBlank String combatLog) {
        Long matchId = combatLogService.ingestCombatLog(combatLog);
        return ResponseEntity.created(URI.create(String.format("/api/match/%s", matchId))).body(matchId);
    }
    ...
    public ResponseEntity<List<HeroKills>> getMatch(@PathVariable("matchId") Long matchId) {
        return ResponseEntity.ok(combatLogService.getHeroKills(matchId));
    }
    ...
    public ResponseEntity<List<HeroItem>> getHeroItems(
        ...
        return ResponseEntity.ok(combatLogService.getHeroItems(matchId, heroName));
    }
    ...
    public ResponseEntity<List<HeroSpells>> getHeroSpells(
            @PathVariable("matchId") Long matchId,
            @PathVariable("heroName") String heroName) {
        return ResponseEntity.ok(combatLogService.getHeroSpells(matchId, heroName));
    }
    ...
    public ResponseEntity<List<HeroDamage>> getHeroDamages(
            @PathVariable("matchId") Long matchId,
            @PathVariable("heroName") String heroName) {
        return ResponseEntity.ok(combatLogService.getHeroDamages(matchId, heroName));
    }
}
